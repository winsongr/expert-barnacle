                ...
                <div class="card gradient-purple-bliss text-center width-400">
                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <h2 class="black font-weight-normal">Vendor Login</h2>
                            <form method="post">
                    ...
                    $sel = $con->query("select * from vendor where email='".$email."' and password='".$pass."'")->num_rows;
                    
                    if($sel != 0)
                    {
                    $_SESSION['vendor_username'] = $email;
                    ?>
                    <script>
