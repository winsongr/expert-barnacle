					...
					<div class="px-3">
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
								...
								<?php 
								$getkey = $con->query("select * from vendor where email='".$_SESSION['vendor_username']."'")->fetch_assoc();
								?>

								<div class="form-group">
									<label for="cname">email</label>
									<input type="text" id="cname" class="form-control"  name="email" value="<?php echo $getkey['email'];?>" required readonly>
								</div>
                                <div class="form-group">
...
$con->query("update vendor set password='".$password."' where email='".$email."'");
